...
ProductDialog::ProductDialog(const QString& file, QWidget* parent)
    : QDialog(parent),
      m_file(file)
{
    ...
    this->connect(m_createButton, SIGNAL(clicked()), this, SLOT(insertProduct()));
}

void ProductDialog::readCompleteFile(void)
{
...
void ProductDialog::insertProduct(void)
{
...
void ProductDialog::removeProduct(void)
{
